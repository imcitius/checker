...
func (a *TTelegramAlerter) Start(ctx context.Context, wg *sync.WaitGroup) {
	...
	a.Alert(ctx, config.TAlertDetails{Severity: "info", Message: "Starting tg bot"})
	a.bot.Start()
}
...
func (a *TTelegramAlerter) Alert(ctx context.Context, alertDetails config.TAlertDetails) {
...
func (a *TTelegramAlerter) Send(ctx context.Context, alertDetails config.TAlertDetails) (*tele.Message, error) {
...
func (a *TTelegramAlerter) AlertCritical(ctx context.Context, alertDetails config.TAlertDetails) {
...
func (a *TTelegramAlerter) SendCritical(ctx context.Context, alertDetails config.TAlertDetails) (*tele.Message, error) {
	//a.Log.Info("TTelegramAlerter Alert")
	if a.bot == nil {
		a.Init(ctx)
	}
